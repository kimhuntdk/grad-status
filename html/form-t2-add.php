                  ...
                  <div class="card">
                    ...
                    <div class="container">
                      <form action="" method="post">
                         ...
                         <label>ส่งครั้งที่ 1 เลือกวิธีการส่งตรวจ</label>
                         <select class="form-control" name="chkVal" id="chkVal">
                            <option value='0'></option>
                            <option value='1'>ส่งไฟล์ในระบบ</option>
                            <option value='2'>ส่งไฟล์ชุดจริงที่ บว</option>
                         </select>
                      </form>
                    <div id="form-data" >
                      <div class="container">
