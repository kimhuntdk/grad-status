          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Calendar /</span> ปฏิทินแจ้งเตือน
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <h4 class="fw-bold py-3 mb-4">รายการแจ้งเตือนปฏิทิน</h4>
                      ...
                      <table class="table ">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">ปฏิทิน</th>
                        ...
                        <tbody>
                        <?php
                          $sql_show = "SELECT * FROM info_calendar left join info_calendar_type ON info_calendar.cal_type_id=info_calendar_type.cal_type_id ";
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php
                            echo $row['cal_type_name']." ".$row['semester']."/".$row['acdemicYear'];
                            ?>
                              </td>                              
                              <td>
                                 <?php
                            ...
                            <div class="dropdown">
                                              ...
                                              <div class="dropdown-menu">
                                                <a class="dropdown-item get_data" href="#" data-cal-id="<?php echo $row['cal_id'];?>" class="btn btn-primary get_data" data-bs-toggle="modal" data-bs-target="#exampleModal"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ฟอร์มแก้ไขปฏิทิน</h5>
    ...
    $('.get_data').on('click',function() {
        var id = $(this).attr("data-cal-id");
        $.post('get-calendar-details.php',{ id:id },function(res){
